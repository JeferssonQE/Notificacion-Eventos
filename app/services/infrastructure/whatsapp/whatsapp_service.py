...
def send_whatsapp_template(
    to: str, nombre: str, movimiento: str, porcentaje: str, valor: str, fecha: str
):
    """
                        ...
                        "rows": [
                            {
                                "id": "ver_dolar",
                                "title": "💵 Ver dólar hoy",
                                "description": "Consulta el tipo de cambio actual",
                            },
                            {
                                "id": "alerta_dolar",
                            ...
                            },
                            {
                                ...
                                "description": "Recibe recordatorios automáticos",
                            },
                            {
                                "id": "facturador",
                                "title": "🧾 Facturador SUNAT",
                                "description": "Envío de facturas y boletas",
                            },
                            {
                                "id": "alerta_apuestas",
                                "title": "🎲 Alerta de apuestas",
                                "description": "Recibe alertas de apuestas deportivas",
                            },
                            {
                                "id": "nosotros",
